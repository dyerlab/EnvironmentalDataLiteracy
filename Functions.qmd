...
Make a new R Script file by selecting *File -\> New File* and selecting `R File` from the command palette (in Positron), or if you are using RStudio, select *File -\> New File -\> R Script*.
