...
Notice how the R code oin the backslashes are replaced with normal text and the values executed by the R code as if it was typed inline.  This is how you can interdigitate R results into your textual output.
