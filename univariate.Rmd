...
> Here we explore methods that focus on a single set of data.  The kinds of hypotheses we address here largely focus on getting information related to the mean value of some observations.  This mean may be for a unary set of data (e.g., the average score in this class is > 90%), the equality of mean values between a pair of sets (e.g., the 2016 class scores were larger than the 2017 class scores), or among any arbitrary number of sets (e.g., among all classes, there is no significant diffrence between mean grades).  
